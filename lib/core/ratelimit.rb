class Core::Ratelimit
  CONFIGS = [
    ...
    { 'pattern' => 'platform/auth/otp#login', 'per_platform_user' => true, 'limit' => 5, 'window' => 1800, 'message' => 'exceeded' },
    { 'pattern' => 'platform/auth/otp#forgot_password', 'per_ip' => true, 'limit' => 5, 'window' => 1800, 'message' => 'exceeded' },
    { 'pattern' => 'platform/auth/otp#verify_mobile', 'per_platform_user' => true, 'limit' => 5, 'window' => 1800, 'message' => 'exceeded' },
